clear;
% Risk estimation comparison(ROC ans AUC curvers) on four datasets using various metrics
...
for i =1:10
    ...
    Res4(i,:) = NRS(xT,yT,xt,yt); % NRS nearest neighebur with hamming distance for risk computation
